                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="new-user-info">
                                        <form action="{{ route('user-dashboard-update', $data_alumni->id) }}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="no_hp"
                                                        name="no_hp" value="{{ $data_alumni->no_hp }}">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="form-label" for="cname">Email</label>
                                                    <input type="text" class="form-control" id="email"
                                                        name="email" value="{{ $data_alumni->email }}">
                                                </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="jabatan"
                                                        name="jabatan" value="{{ $data_alumni->jabatan }}">
                                                </div>
