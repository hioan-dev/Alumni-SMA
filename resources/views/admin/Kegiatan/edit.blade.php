                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="title" name="title"
                                                    placeholder="Enter Judul Berita" value="{{ $kegiatan->title }}">
                                            </div>
                                            <div class="form-group col-md-12">
                                                ...
                                                <select type="text" name="informasi" class="form-control">
                                                    <option value="akan datang"
                                                        {{ $kegiatan->informasi === 'akan datang' ? 'selected' : '' }}>
                                                        Akan Datang</option>
                                                    <option value="selesai"
                                                        {{ $kegiatan->informasi === 'selesai' ? 'selected' : '' }}>Selesai
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-12">
                                                ...
                                                <label for="gambar">Thumbnail Sebelumnya</label>
                                                <br>
                                                <img src="{{ asset('storage/' . $kegiatan->thumbnail) }}" alt=""
                                                    width="100px">
                                            </div>
                                            <div class="form-group col-md-12">
