    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('panitia-munas') ? 'active' : '' }}" aria-current="page"
                        href="{{ route('panitia-munas.index') }}">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="icon-20">
                                <path opacity="0.4"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('calon-ketua') ? 'active' : '' }}" aria-current="page"
                        href="{{ route('calon-ketua.index') }}">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="icon-20">
                                <path opacity="0.4"
                        ...
                        <span class="item-name">Calon Ketua</span>
                    </a>
                </li>
                <li class="nav-item static-item">
                    <a class="nav-link static-item disabled" href="#" tabindex="-1">
                ...
                <li class="nav-item">
                    <a class="nav-link  {{ Request::is('gallery-vidio') ? 'active' : '' }}"
                        ...
                        <i class="sidenav-mini-icon"> GV </i>
                        <span class="item-name">Galeri Vidio</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('iuran-konfirmasi') ? 'active' : '' }}"
                        ...
                        <i class="sidenav-mini-icon"> KI </i>
                        <span class="item-name">Konfirmasi Iuran</span>
                    </a>
                </li>
            </ul>
            <!-- Sidebar Menu End -->
